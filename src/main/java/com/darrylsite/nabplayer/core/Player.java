...
/**
 *
 * @author Darryl Kpizingui, ASEOR SAS
 */
public class Player
{
    ...
    private boolean isVolSet = false;
    /**
    ...
    {
        /*
        FloatControl volume = audio.getVolume();
        volume.setValue(v);
        */
    }
    ...
    {
        return 0;
       // return audio.getVolume().getValue();
    }
